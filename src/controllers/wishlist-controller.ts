...
class WishlistController {
  async productToWishlist(req: Request | any, res: Response, next: NextFunction) {
  ...
  async deleteProductInWishlist(req: Request | any, res: Response, next: NextFunction) {
    const { id } = req.params;
    const userId = req.user.id;
  ...
  async getProductsInWishlist(req: Request | any, res: Response, next: NextFunction) {
    const userId = req.user.id;
